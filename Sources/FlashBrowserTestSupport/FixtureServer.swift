...
///
/// Why this exists: Vimium's content script needs a normal page origin;
/// data: URLs are special enough that extension behavior differs from a
/// real page. Serving from http://127.0.0.1:<port>/ keeps tests offline
/// while exercising the browser-extension path we care about.
///
