...
#
# Usage:
#   ./Scripts/test-vimium-parity.sh                      # full setup + run all fixtures
#   ./Scripts/test-vimium-parity.sh --fixture baseline-synthetic
#   ./Scripts/test-vimium-parity.sh --update-allow-list
#   ./Scripts/test-vimium-parity.sh --setup-only         # provision + build, don't run
...
// Generated by Scripts/test-vimium-parity.sh.
