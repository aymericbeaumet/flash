...
cross-stack test suite: every SDK (Rust, Python, TypeScript, Ruby, Go, Zig,
Swift) must behave identically under them, and every protocol bug gets a
minimal repro spec before its fix lands in each SDK. This package is the
engine: it spawns one fresh plugin process per spec with a production-scrubbed
