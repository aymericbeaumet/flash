...
"$PROJECT_DIR/Scripts/build-plugins.sh"
...
# Stage each bundled plugin: only its manifest and compiled binary ship —
# no Rust sources, no cargo metadata.
PLUGINS_DEST="$STAGING_PATH/Contents/Resources/Plugins"
